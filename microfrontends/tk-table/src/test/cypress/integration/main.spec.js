...
describe('Main', () => {
  ...
  describe('Table widget', () => {
    ...
    it('should display all the entity fields in the component', () => {
      cy.contains('entities.tk.id').scrollIntoView().should('be.visible');
      cy.contains('entities.tk.field1').scrollIntoView().should('be.visible');
      cy.contains('entities.tk.field2').scrollIntoView().should('be.visible');
    });
  });
});
