...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/tk/tableWidget/>):
   1. Run `npm i`
...
- **tk.table.error** (fired when an error occurs)
- **tk.table.select** (fired when a table row is selected)
