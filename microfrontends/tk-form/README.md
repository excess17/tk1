...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/tk/formWidget/>):
   1. Run `npm i`
...
- **tk.form.createError** (fired when an error occurs during tk creation)
- **tk.form.create** (fired when the tk is successfully created)
- **tk.form.updateError** (fired when an error occurs during tk update)
- **tk.form.update** (fired when the tk is successfully updated)
